...
function re() {
  ...
  return R.Fragment = E, R.jsx = i, R.jsxs = i, R;
}
var _ = {};
/**
 * @license React
  ...
  return F || (F = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function j(e, r, t, n, l, u, A, S) {
      ...
      if (h.call(r, "key")) {
        ...
        n = 0 < b.length ? "{key: someKey, " + b.join(": ..., ") + ": ...}" : "{key: someKey}", $[o + n] || (b = 0 < b.length ? "{" + b.join(": ..., ") + ": ...}" : "{}", console.error(
...
const se = ({
  ...
  const d = `cui-button cui-button--${f} ${i}`.trim();
